...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Page'
        db.create_table(u'simple_publishing_page', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['simple_publishing.Page'])),
        ...
        db.send_create_signal(u'simple_publishing', ['Page'])


    def backwards(self, orm):
        # Deleting model 'Page'
        db.delete_table(u'simple_publishing_page')
